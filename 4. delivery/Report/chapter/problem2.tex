...
As more generally stated in problem 1 a combination of the two methods are beneficial as they introduce two different aspects of verification. With tests defects can be found and located in the software, with formal methods the absence of defects can be verified.
